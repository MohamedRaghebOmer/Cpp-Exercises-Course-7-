...
int ColSum(int arr[][3], short NumOfCol, short Rows)
{
	int SumOfOneCol = 0;

	for (short i = 0; i < Rows; i++)
	{
		SumOfOneCol += arr[i][NumOfCol];
	}

	return SumOfOneCol;
}

void PrintColSum(int arr[][3], short Rows, short Col)
{
...
int main()
{
	...
	int arr[Rows][Col]; // If you want to change col, edit it in line 13, 24, 37, 49, 61
